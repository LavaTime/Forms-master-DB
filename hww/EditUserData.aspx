<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="EditUserData.aspx.cs" Inherits="hww.EditUserData" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="styleSheets/updateInfoStyleSheet.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholderBody" runat="server">
    <script type="text/javascript">
        ...
        function checkAll() {
            /*
             * 
             * CANNOT SEPERATE JS FILES BECAUSE OF < %    %>
             * 
             * 
        ...
        function otherGender() {
            ...
            if (document.getElementById("other").checked) {
                ...
                document.getElementById("notListedGender").value = "";
            }
        }
        ...
        default:
            ...
            document.getElementById("notListedGender").style.visibility = "visible";
            document.getElementById("notListedGender").value = "<%= RGender%>".slice(4, -1) + "<%= RGender%>".slice(-1);
                    break;
            }
        }
        ...
        document.getElementById("phone").value = <%=Rphone %>;
            }
        }
        ...
        function loadDate() {
            ...
            var Rdate = splitted[0];
            if (Rdate.length == 1) {
                Rdate = "0" + Rdate;
            }
            var Ryear = splitted[2].slice(0, 2);
            if (parseInt(Ryear) > 20) {
                Ryear = "19" + Ryear;
            } else {
                Ryear = "20" + Ryear;
            }
            var fullDate = Ryear + "-" + Rmonth + "-" + Rdate;
        ...
        <table>
            <tr>
                <td>שם משתמש</td>
                <td><input type="text" id="username" name="username" required autocomplete="on" onchange="checkUsername()" value="<%=Rusername %>" disabled="disabled"/></td>
                <td><p id="errUsername" class="err"></p></td>
            </tr>
                <tr>
                <td>סיסמה</td>
                <td><input type="password" id="password" name="password" required autocomplete="on" onchange="checkPassword()" value="<%=Rpassword %>"/></td>
                <td><p id="errPassword" class="err"></p></td>
            </tr>
            <tr>
                <td>שם פרטי</td>
                <td><input type="text" id="firstName" name="firstName" required autocomplete="on" onchange="checkFirstName()" value="<%=RfirstName %>"/></td>
                <td><p id="errFirstName" class="err"></p></td>
            </tr>
            <tr>
                <td>שם משפחה</td>
                <td><input type="text" id="lastName" name="lastName" required autocomplete="on" onchange="checkLastName()" value="<%=RlastName %>"/></td>
                <td><p id="errLastName" class="err"></p></td>
            </tr>
            <tr>
                <td>כתובת אימייל</td>
                <td><input type="email" id="email" name="email" required autocomplete="on" onchange="checkEmail()" value="<%=Remail %>"/></td>  <!--- add onchange checkEmail FIXED --->
                <td><p id="errEmail" class="err"></p></td>
            </tr>
            <tr>
                <td>טלפון</td>
                <td><input type="tel" id="phone" name="phone" autocomplete="on" onchange="checkPhone()" value=""/></td>  <!--- add onchange check phone FIXED --->
                <td><p id="errPhone" class="err"></p></td>
            </tr>
            <tr>
                <td>כתובת</td>
                <td><input type="text" id="address" name="address" autocomplete="on" value="<%=Raddress %>"/></td> <!--- add onchange check address FIXED --->
            ...
            <tr>
                <td>גיל</td>
                <td><input type="number" value="<%= Rage%>" name="ageInput" id="ageInput" readonly/></td>
            </tr>
            <tr>
                <td>
                    <input type="submit" id="update" name="SubmitEdit" onclick="return checkAll();" value="עדכן" />
                </td>
            </tr>
            <tr>
                <td>
